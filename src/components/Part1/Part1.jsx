  ...
  return (
    <div className='imgBackground'>
        <article className='mx-auto relative h-44 w-10/12 md:w-7/12'>
            <div className='flex pt-6 md:mb-0 mb-2'>
                <h1 className='text-7xl font-bold text-slate-500'>01</h1>
                <div className='pt-6'>
                    <h1 className='text-xl font-bold text-slate-700'>HISTORY</h1>
                    <div className='bg-slate-500 h-3.5 w-3.5'></div>
                </div>
            </div>
            <div className='text-xs md:ml-16 text-justify'>
